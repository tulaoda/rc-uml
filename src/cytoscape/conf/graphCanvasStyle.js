const style = {
    ...
    'edge.normal': {
        ...
        'source-arrow-shape': 'circle',
        'source-endpoint': (ele) => {
            const deg = ele.data().relativePosition === 0 ? '90deg' : '270deg'
            return deg
        },
        'target-endpoint': (ele) => {
    ...
    'edge.mapping': {
        ...
        'source-arrow-shape': 'circle',
        'source-endpoint': (ele) => {
            const deg = ele.data().relativePosition === 1 ? '90deg' : '270deg'
            return deg
        },
        'target-endpoint': (ele) => {
            const deg = ele.data().relativePosition === 1 ? '270deg' : '90deg'
            return deg
        },
    },
}
